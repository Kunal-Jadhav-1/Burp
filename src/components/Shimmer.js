import logo_load from '../images/logo_load.png';

const Shimmer = () => {
    return (
        <div className="flex flex-wrap m-2 mx-14 ">
            <div className="m-3 p-2 w-64 h-96 animate-pulse bg-gray-100 rounded-md">
            ...
            <div className="m-3 p-2 w-64 h-96 bg-gray-100 animate-pulse rounded-md">
                <div className="h-36 w-60 my-1 rounded-md cursor-pointer bg-gray-300" ></div>
                <h3 className="rounded-md text-center m-6 text-gray-900 bg-gray-300 h-10 w-200 ml-22"></h3>
                <h5 className="rounded-md text-center m-6 text-gray-900 bg-gray-300 h-10 w-200 ml-22"></h5>
                <h5 className="rounded-md text-center m-6 text-gray-900 bg-gray-300 h-10 w-200 ml-22"></h5>
        ...
        // <div className="w-[400] h-[300] py-[350] mx-auto bg-gray-200 animate-pulse">
        //     <img src={logo_load}></img>
        // </div>
    );
}
