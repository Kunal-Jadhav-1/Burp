                        ...
                        <div key={item?.card?.info?.id} className=" border border-solid border-b-gray-500 border-t-gray-500 py-2 px-3 bg-sky-50 flex justify-between">
                            ...
                            <div className="items-center flex">
                                ...
                                <div className="w-36 absolute">
                                    <button className=" my-5 mx-[48] px-[6] py-[5] w-[60] absolute bg-sky-500 text-white rounded-lg hover:bg-orange-300 hover:text-black text-sm" onClick={() => handleAddItem(item)}>Add +</button>
                                </div>
                            </div>
                        </div>
                    )
