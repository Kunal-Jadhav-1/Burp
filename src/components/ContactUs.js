const ContactUs = () => {
    return (
        <div className="my-4 bg-secondary text-primary text-center rounded-lg p-6  w-2/3 mx-auto">
            <h1 className="text-3xl font-bold mb-12 mt-6 text-center">Contact Us</h1>
